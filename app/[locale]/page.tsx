      ...
      <div className="relative bg-zinc-900 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-5 py-32 md:py-48 text-center flex flex-col items-center">
          <div className="inline-flex items-center gap-2 bg-primary/20 border border-primary/30 rounded-full px-4 py-1.5 mb-8 backdrop-blur-sm">
            ...
            <span className="text-primary-200 text-sm font-medium tracking-wide">Voyager Autrement en Amérique Latine</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-zinc-300 mb-10 max-w-2xl mx-auto leading-relaxed">
            Récits, itinéraires éco-responsables et immersion totale dans la culture locale.
          </p>
      ...
      <div className="py-24 bg-white dark:bg-zinc-950">
        <div className="container mx-auto px-5 max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 border-b dark:border-zinc-800 pb-6">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-zinc-900 dark:text-white mb-4">Derniers Articles</h2>
              <p className="text-xl text-zinc-600 dark:text-zinc-400">Plongez dans nos récentes découvertes</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {latestArticles.length === 0 ? (
              <p className="text-center col-span-full text-zinc-500 py-12">
                Le blog est en cours de préparation.
              </p>
            ) : (
      ...
      <footer className="bg-zinc-950 text-zinc-400 py-16 border-t border-zinc-900">
        <div className="container mx-auto px-5 text-center">
          ...
          <p className="max-w-md mx-auto text-zinc-500 mb-8">
            MySenda - Inspirer des voyages plus lents, plus locaux et plus respectueux en Amérique Latine et au-delà.
          </p>
          <div className="flex flex-wrap justify-center gap-6 text-sm mb-12">
            <Link href={`/${locale}/privacy`} className="hover:text-primary transition-colors">Confidentialité</Link>
            <Link href={`/${locale}/terms`} className="hover:text-primary transition-colors">Conditions</Link>
          </div>
          <div className="pt-8 border-t border-zinc-900 text-sm text-zinc-600">
            <p>© {new Date().getFullYear()} MySenda. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
    </div>
